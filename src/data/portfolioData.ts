...
export const projectsData: Project[] = [
  ...
  },
  {
    ...
    status: "Active Build",
    shortDescription: "A browser extension that helps developers and designers inspect the structure, typography, colors, and visual properties of websites instantly.",
    fullDescription: "Instead of manually opening browser DevTools, navigating complicated DOM trees, and digging through endless computed CSS rules, Design Inspector provides an instant, point-and-click overlay that surfaces typography, color palettes, element dimensions, and visual hierarchy on any live website.",
